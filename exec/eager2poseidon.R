...
parser <- optparse::add_option(parser, c("-c", "--credentials"),
  type = "character",
...
parser <- optparse::add_option(parser, c("-S", "--single_stranded_sample_suffix"),
...
parser <- optparse::add_option(parser, c("-t", "--trust_uncalibrated_dates"),
  type = "logical",
...
parser <- optparse::add_option(parser, c("-k", "--keep_only"),
  type = "character",
...
parser <- optparse::add_option(parser, c("-s", "--contamination_snp_cutoff"),
  type = "integer",
...
parser <- optparse::add_option(parser, c("-p", "--genotypePloidy"),
  type = 'character',
...
parser <- optparse::add_option(parser, c("-o", "--output_janno"),
  type = "character",
